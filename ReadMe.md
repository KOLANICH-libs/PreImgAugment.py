...
================
~~[wheel (GitLab)](https://gitlab.com/KOLANICH-libs/PreImgAugment.py/-/jobs/artifacts/master/raw/dist/PreImgAugment-0.CI-py3-none-any.whl?job=build)~~
...
~~![GitLab Build Status](https://gitlab.com/KOLANICH-libs/PreImgAugment.py/badges/master/pipeline.svg)~~
~~![GitLab Coverage](https://gitlab.com/KOLANICH-libs/PreImgAugment.py/badges/master/coverage.svg)~~
